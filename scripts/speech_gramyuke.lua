...
return {
	ACTIONFAIL =
	{
        ...
        REPAIR =
        {
            WRONGPIECE = "This doesn’t go there…",
        },
        BUILD =
        {
            MOUNTED = "Nah I can’t do that.",
            HASPET = "Im not replacing my friend!",
			TICOON = "I'm too invested in my own Ticoon to follow another one.",
        },
		SHAVE =
		{
			AWAKEBEEFALO = "He’s awake…I don’t want to",
		...
		STORE =
		{
            ...
            NOTMASTERCHEF = "I ain’t got that kinda skill",
		},
        CONSTRUCT =
        {
            ...
            NOTREADY = "It’s not ready to come out",
        },
		RUMMAGE =
		{
			GENERIC = "Nuh uh!",
			INUSE = "They're elbow deep in shit right now.",
            NOTMASTERCHEF = "Nope! I don’t have the skill",
		},
		UNLOCK =
        {
        	WRONGKEY = "Nuh uh",
		...
		ACTIVATE =
		{
            ...
            HOSTBUSY = "He seems a bit busy",
            CARNIVAL_HOST_HERE = "He's around here somewhere...",
            NOCARNIVAL = "I eated all the birds",
			EMPTY_CATCOONDEN = "Ugh…No one’s home",
			KITCOON_HIDEANDSEEK_NOT_ENOUGH_HIDERS = "I wish there were more of them",
			KITCOON_HIDEANDSEEK_NOT_ENOUGH_HIDING_SPOTS = "Where are they supposed to hide",
			KITCOON_HIDEANDSEEK_ONE_GAME_PER_DAY = "I think that's enough for one day",
            MANNEQUIN_EQUIPSWAPFAILED = "Nuh uh",
            PILLOWFIGHT_NO_HANDPILLOW = "I need a pillow to fight with!",
		},
		OPEN_CRAFTING =
		{
            PROFESSIONALCHEF = "Dude I dont’t have the skill",
			SHADOWMAGIC = "On god",
		},
        COOK =
        {
            GENERIC = "I don’t feel like cooking",
            INUSE = "Looks like we had the same idea.",
            TOOFAR = "Too far man…",
        },
        START_CARRAT_RACE =
        {
            NO_RACERS = "I think I'm missing something",
        },
        ...
        OCEAN_FISHING_POND =
		{
			WRONGGEAR = "Nope, nuh uh. Wrong rod!",
		},
        ...
        GIVE =
        {
            ...
            DEAD = "I’ll take it methinks..",
            SLEEPING = "Eepy",
            BUSY = "Later…",
            ABIGAILHEART = "At least I tried…",
            GHOSTHEART = "Nuh uh Ion wanna",
            NOTGEM = "Wrong hole",
            WRONGGEM = "Wrong gem…",
            NOTSTAFF = "This might be the wrong shape..",
            MUSHROOMFARM_NEEDSSHROOM = "Muscroom",
            MUSHROOMFARM_NEEDSLOG = "I think I need a log",
            MUSHROOMFARM_NOMOONALLOWED = "The mushies dont wanna",
            SLOTFULL = "Occupied!",
            FOODFULL = "Theres food already!",
            NOTDISH = "It won't want to eat that…",
            DUPLICATE = "We already know that one.",
            NOTSCULPTABLE = "This ain’t right",
            NOTATRIUMKEY = "Wrong shape…",
            CANTSHADOWREVIVE = "This thing doesn’t wanna live!",
            WRONGSHADOWFORM = "It's not put together right",
            NOMOON = "I need the moon first!",
			PIGKINGGAME_MESSY = "I wanna get clean…",
			PIGKINGGAME_DANGER = "It's too dangerous",
			PIGKINGGAME_TOOLATE = "It's too late for that",
			CARNIVALGAME_INVALID_ITEM = "Not enough minecoins",
			CARNIVALGAME_ALREADY_PLAYING = "A game is already underway",
            SPIDERNOHAT = "I can't fit them in my pocket",
            TERRARIUM_REFUSE = "Maybe I should experiment with different kinds of fuel...",
            TERRARIUM_COOLDOWN = "It’s not ready yet",
            NOTAMONKEY = "Oo oo aa aa",
            QUEENBUSY = "She seems busy…",
        },
        GIVETOPLAYER =
        {
            FULL = "Your pockets too small",
            DEAD = "It’s mine now",
            SLEEPING = "Hooonk mimimimi",
            BUSY = "I’ll try later",
        },
        GIVEALLTOPLAYER =
        {
        ...
        MOUNT =
        {
            TARGETINCOMBAT = "Dude I’m not gonna do that",
            INUSE = "Damnit I wanted that!",
			SLEEPING = "Rise and grind!",
        },
        SADDLE =
        {
            TARGETINCOMBAT = "Too pissed",
        },
        TEACH =
        {
            --Recipes/Teacher
            ...
            WRONGWORLD = "This map doesnt feel right",

			--MapSpotRevealer/messagebottle
			MESSAGEBOTTLEMANAGER_NOT_FOUND = "Hmmm…I don’t get it…",--Likely trying to read messagebottle treasure map in caves
        ...
        WRAPBUNDLE =
        {
            EMPTY = "What am I supposed to wrap?",
        },
        PICKUP =
        {
			RESTRICTION = "Nah, I can’t ",
			INUSE = "I gotta wait!",
        ...
        REPLATE =
        {
            MISMATCH = "Wrong doodad",
            SAMEDISH = "I can only use one doohickey",
        },
        SAIL =
        {
        	REPAIR = "It looks fine to me",
        },
        ROW_FAIL =
        {
        ...
        {
            GLASSED = "Glass…",
            ALREADY_BOMBED = "Theres already a pool rock",
        },
		GIVE_TACKLESKETCH =
		{
			DUPLICATE = "Nah",
		...
		COMPARE_WEIGHABLE =
		{
            FISH_TOO_SMALL = "Baby glaggle!",
            OVERSIZEDVEGGIES_TOO_SMALL = "Too skinny!",
		},
        BEGIN_QUEST =
        {
        ...
        {
            GENERIC = "I’m already smart",
            FERTILIZER = "Nuh uh",
        },
        FILL_OCEAN =
        {
            UNSUITABLE_FOR_PLANTS = "Wrong water maybe…",
        },
        POUR_WATER =
        {
            OUT_OF_WATER = "No more…",
        },
        POUR_WATER_GROUNDTILE =
        {
            OUT_OF_WATER = "No more oiter…",
        },
        USEITEMON =
        {
            --GENERIC = "Nah",
        ...
        HITCHUP =
        {
            NEEDBEEF = "If I had a bell I could befriend a boofie.",
            NEEDBEEF_CLOSER = "My boofie buddy is too far away.",
            BEEF_HITCHED = "My boofie is already hitched up.",
            INMOOD = "My boofie seems to be too lively.",
        },
        MARK =
        {
            ALREADY_MARKED = "I've already made my pick",
            NOT_PARTICIPANT = "I can’t participate!",
        },
        YOTB_STARTCONTEST =
        {
            DOESNTWORK = "Awww..",
            ALREADYACTIVE = "Probably busy…",
        },
        YOTB_UNLOCKSKIN =
        {
            ALREADYKNOWN = "Don’t I already know this?",
        },
        CARNIVALGAME_FEED =
        {
        ...
        HERD_FOLLOWERS =
        {
            WEBBERONLY = "Methinks only webber would get that..",
        },
        BEDAZZLE =
        {
        ...
        HARVEST =
        {
            DOER_ISNT_MODULE_OWNER = "Hmmm…It doesn’t wanna",
        },
	...
	{
		NO_INGREDIENTS = "I’m missing a gizmo",
	...
	ANNOUNCE_COLD = "I like the cold but this is getting a bit too cold for me..",
	ANNOUNCE_HOT = "Need ice…",
	ANNOUNCE_CRAFTING_FAIL = "I'm missing a couple key ingredients.",
	ANNOUNCE_DEERCLOPS = "That sounded big!",
	ANNOUNCE_CAVEIN = "It’s crumbling",
	...
	ANNOUNCE_EAT =
	{
		GENERIC = "Monch monch",
		PAINFUL = "Eugh…Yucky…",
		SPOILED = "What the fuck ew",
		STALE = "That was long gone..",
		INVALID = "Nuh uh",
        YUCKY = "Nasty ass",
    ...
    ANNOUNCE_RUINS_RESET = "Look who came crawling back…",
    ANNOUNCE_SNARED = "Sharp bones!!",
    ANNOUNCE_SNARED_IVY = "Plants aren’t supposed to do that!",
    ANNOUNCE_REPELLED = "It's shielded!",
	ANNOUNCE_ENTER_DARK = "It's so dark!",
	ANNOUNCE_ENTER_LIGHT = "Fucking finally",
	ANNOUNCE_FREEDOM = "I'm free! I'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "I feel so smar…",
	ANNOUNCE_HOUNDS = "Did you hear that?",
	ANNOUNCE_WORMS = "Did you feel that?",
	ANNOUNCE_HUNGRY = "I’m STARFING",
	...
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "This mud can't hold a footprint.",
	ANNOUNCE_INV_FULL = "I‘m so full",
	ANNOUNCE_KNOCKEDOUT = "Ugh, my head!",
	ANNOUNCE_LOWRESEARCH = "I didn't learn very much from that.",
	ANNOUNCE_MOSQUITOS = "STOPPIT",
    ANNOUNCE_NOWARDROBEONFIRE = "Fire fire FIRE",
    ANNOUNCE_NODANGERGIFT = "There are monsters nearby…",
    ANNOUNCE_NOMOUNTEDGIFT = "I should get off my boofie first.",
	ANNOUNCE_NODANGERSLEEP = "I'm too scared…",
	ANNOUNCE_NODAYSLEEP = "It's too bright out.",
	ANNOUNCE_NODAYSLEEP_CAVE = "No sleep nuh uh",
	ANNOUNCE_NOHUNGERSLEEP = "Tummy RUMBLIN’! I gotta eat first",
	ANNOUNCE_NOSLEEPONFIRE = "IM ON FIRE I CANT SLEEP",
	...
	ANNOUNCE_WORMHOLE = "Jesus wouldn’t have done it",
	ANNOUNCE_TOWNPORTALTELEPORT = "I'm not sure that was science...",
	ANNOUNCE_CANFIX = "\nI think I can fix this!",
	ANNOUNCE_ACCOMPLISHMENT = "I’m silly!",
	ANNOUNCE_ACCOMPLISHMENT_DONE = "If only my friends could see me now...",
	ANNOUNCE_INSUFFICIENTFERTILIZER = "Need any food buddy?",
	ANNOUNCE_TOOL_SLIP = "Oooo slippy!",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "I don’t like lightnight…",
	ANNOUNCE_TOADESCAPING = "ITS TRYING TO ESCAPE",
	ANNOUNCE_TOADESCAPED = "Damn…bye buddy!",


	ANNOUNCE_DAMP = "Sloppy!",
	ANNOUNCE_WET = "Eugh I’m all sloppy!!",
	ANNOUNCE_WETTER = "Slop",
	ANNOUNCE_SOAKED = "I’m SOPPING wet",

	ANNOUNCE_WASHED_ASHORE = "Sopped but alive!",

    ANNOUNCE_DESPAWN = "I can see the light!",
	ANNOUNCE_BECOMEGHOST = "oOooOooo!!",
	ANNOUNCE_GHOSTDRAIN = "Im going silly…",
    ...
    ANNOUNCE_ATTACH_BUFF_MOISTUREIMMUNITY  = "I feel as dry as one of Foreskinnius’ lectures!",
	...
	ANNOUNCE_OCEANFISHING_IDLE_QUOTE =
	{
		...
		"I could be doing so many more goody things right now...",
	},
    ...
    ANNOUNCE_ARCHIVE_NEW_KNOWLEDGE = "Expand!",
    ...
    ANNOUNCE_FERTILIZER_RESEARCHED = "I never thought I'd be applying my large brain mind to... this.",
	...
	{
		GENERIC = "Fuck him up!",
		PIG = "I want your bacon!",
		PREY = ":3",
		SPIDER = "I'm going to stomp you dead!",
		SPIDER_WARRIOR = "Better you than me!",
		DEER = "IM GONNA GET YOU",
	},
	COMBAT_QUIT =
	{
		GENERIC = "I sure showed him!",
		PIG = "I wasn’t silly enough…",
		PREY = "God he’s fast!",
		SPIDER = "At least I’m not covered in spider goo…",
		SPIDER_WARRIOR = "Go away! Shoo!",
	},

	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "Whadahel",
        MULTIPLAYER_PORTAL_MOONROCK = "I'm sure there's some kind of explanation for this.",
        MOONROCKIDOL = "Amen",
        CONSTRUCTION_PLANS = "Science doodads!",

        ANTLION =
        {
            GENERIC = "It wants me so bad",
            VERYHAPPY = "I think we're on good terms.",
            UNHAPPY = "It looks angy...",
        },
        ...
        ABIGAIL_FLOWER =
        {
			...
			LEVEL3 = "Looks like someone's feeling giddy today!",

			-- deprecated
            LONG = "It hurts my soul to look at that thing...",
            MEDIUM = "It's giving me the heeby jeebies...",
        ...
        BERNIE_ACTIVE = "Thats a cool stuffie!",
        BERNIE_BIG = "Zoo wee mama…",

		BOOKSTATION =
		{
			GENERIC = "Uuuuugh…",
			BURNT = "Finally, no more!",
		},
        ...
        {
            GENERIC = "Haiii %s!",
            ATTACKER = "%s looks sus...",
            MURDERER = "Killer!",
            REVIVER = "%s, boo buddy!",
            GHOST = "%s needs a heart…",
            FIRESTARTER = "What was the point of that, %s.",
        },
        WILSON =
        {
            ...
            MURDERER = "Killa, %s!",
            REVIVER = "%s thinks they’re some kinda wizard!",
            GHOST = "Gotta get them back on their feet!",
            FIRESTARTER = "%s...Why…",
        },
        WOLFGANG =
        {
            ...
            GHOST = "I told you you couldn't deadlift that boulder",
            FIRESTARTER = "You can't actually \"fight\" fire, %s!",
        },
        WAXWELL =
        {
            GENERIC = "Arigato gozaimasu, %s!",
            ATTACKER = "Seems you've gone from \"dapper\" to \"slapper\".",
            MURDERER = "Time for a knuckle sandwich",
            REVIVER = "%s so whimsical!",
            GHOST = "Don't look at me like that %s",
            FIRESTARTER = "%s's just asking to get roasted.",
        },
        WX78 =
        {
            GENERIC = "Hello, %s!",
            ATTACKER = "I think theres something wrong with you, %s...",
            MURDERER = "%s! You FREAK!",
        ...
        {
            GENERIC = "Ohayo, %s!",
            ATTACKER = "%s has been a bit of a bitch lately...",
            MURDERER = "Murderer! Bring me an axe and let's get in the swing of things!",
            REVIVER = "%s saved everyone's booty tooty.",
            ...
            MOOSE = "Canada’s Icon",
            MOOSEGHOST = "That moose'nt be very silly.",
            GOOSE = "Honk",
            GOOSEGHOST = "Shouldn’t have been so silly",
            FIRESTARTER = "Don't burn yourself out, %s.",
        },
        WICKERBOTTOM =
        {
            GENERIC = "%s, my slime.",
            ATTACKER = "I think %s's planning to throw it back",
            MURDERER = "Here comes my peer review!",
            REVIVER = "I have deep respect for %s's bootay",
        ...
        {
            GENERIC = "Peaches, %s!",
            ATTACKER = "%s is silent, but deadly...like a fard",
            MURDERER = "Baka",
            REVIVER = "%s thinks outside the doohickey doodad gizmo box.",
            GHOST = "How do you say \"I'll get a revival device\" in spanish?",
            FIRESTARTER = "That how it be in the hood cuh",
        },
        WEBBER =
        {
            GENERIC = "Nice tits, %s!",
            ATTACKER = "I'm gonna roll up a newspaper, just in case.",
        ...
        WALTER =
        {
            GENERIC = "We gotta cook, %s!",
            ATTACKER = "Is that how a Pinetree Pioneer is meant to behave?",
            MURDERER = "Did you run out of material for your meth, %s?",
        ...
        MIGRATION_PORTAL =
        {
        --    GENERIC = "I wanna go there one day",
        --    OPEN = "If I step through, will I still be sexy?",
        ...
        MUSHROOM_LIGHT2 =
        {
            ON = "Blue is obviously the most nonbinary color.",
            OFF = "We could make a prime light source with some primary colors.",
            BURNT = "I didn't mildew it, I swear.",
        },
        MUSHROOM_LIGHT =
        {
            ON = "Mycelium makes it light up.",
            OFF = "It's a big shroom.",
        ...
        MUSHTREE_TALL =
        {
            GENERIC = "That mooma got too big for its own good.",
            BLOOM = "You can't tell from far away, but it's quite stanky...",
        },
        MUSHTREE_MEDIUM =
        {
            GENERIC = "These used to grow in my bathroom walls",
		...
		ANIMAL_TRACK = "Tracks left by a discord user probably",
		ARMORGRASS = "Probably full of buggies",
		ARMORMARBLE = "That looks really heavy.",
		ARMORWOOD = "That is a perfectly reasonable piece of clothing.",
		ARMOR_SANITY = "Wearing that makes me feel like a dork",
		ASH =
		{
			GENERIC = "Probably tastes good on ham",
		...
		BACKPACK = "You could fit a whole lot of dildos in there.",
		BACONEGGS = "The perfect breakfast for a hoe like me.",
        ...
        BEEQUEENHIVEGROWN = "How in hell did it get so big?!",
		...
		BERRIES_COOKED = "Eugh..Mushy..",
        BERRIES_JUICY = "Mmmmm juicy!",
        BERRIES_JUICY_COOKED = "Im gonna fuck that shit up",
		BERRYBUSH =
		{
			BARREN = "Its all out",
			WITHERED = "Nothings gonna save you now",
			GENERIC = "I want some",
			PICKED = "Maybe they'll grow back?",
			DISEASED = "It looks pretty sick.",--removed
			DISEASING = "Err, something's not right.",--removed
			BURNING = "Well that sucks",
		},
		BERRYBUSH_JUICY =
		{
		...
		BIRD_EGG = "A future meal",
		BIRD_EGG_COOKED = "Scrambled, please!",
		...
		COOKINGRECIPECARD = 
		{
			GENERIC = "Mmmmph…I’ll figure it out…",
		},
		BLUE_CAP = "Looks ass",
		...
		CHARCOAL = "I don’t wanna get black lung",
		...
		CHESTER_EYEBONE =
		{
			GENERIC = "It looks cool, gimme!",
			WAITING = "It went to eep…",
		},
		COOKEDMANDRAKE = "I don’t feel THAT bad",
		COOKEDMEAT = "Charbroiled to perfection.",
		COOKEDMONSTERMEAT = "I don’t want to eat it",
		...
		SHADOW_FORGE = "Evil deed maker",
		SHADOW_FORGE_KIT = "I gotta fuck around with this!",
    ...
    DESCRIBE_PLANTSTRESSORNUTRIENTS = "This poor plant needs foodies!",
